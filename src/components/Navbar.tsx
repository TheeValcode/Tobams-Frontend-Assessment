        ...
        <div className="hidden md:flex items-center gap-3">
          ...
          <div className="relative">
            <button
              ...
              className="inline-flex items-center gap-2 bg-brand-purple text-white px-4 py-2 rounded-md text-sm font-medium hover:bg-brand-purple-light transition-colors"
