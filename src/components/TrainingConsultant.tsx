  ...
  return (
    <section className="w-full bg-[#E9E2E7] py-12 md:py-16 border-t border-slate-200">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8">
        ...
        {/* Accelerate Growth CTA Banner */}
        <div className="pt-6">
          <div className="bg-brand-purple-dark text-white rounded-2xl p-8 sm:p-10 text-center space-y-5 shadow-xl">
            <h3 className="text-lg sm:text-xl md:text-2xl font-medium text-white max-w-2xl mx-auto">
